...
<header>
  ...
  <div class="container">
        <div id="infoGen">
            <div class="row">
                <div class="col-12">
                    <h2>@lang('messages.Banco') </h2><!--Banco del tiempo-->
                    <p>
                            @lang('messages.Buscamos') 
                        <!--Lo que buscamos con esta plataforma son tres cosas principales:-->
                    </p>
                    <ul>
                        <li>@lang('messages.UnaCom') <!--Una comunidad unida y servicial--></li>
                        <li>@lang('messages.AyudaMutua') <!--Ayuda mutua entre usuarios--></li>
                        <li>@lang('messages.NoImporDinero') <!--No darle nada de importancia al dinero--></li>
                    </ul>
                </div>
            </div>
            <div class="row">
            ...
            <div class="row">
                <div class="col-8">
                    <ul>
                        <li><b>@lang('messages.Trabajador') :<!--Trabajador :--></b></li><br>
                        <p>
                        ...
                        <a class="ejemplo"><b>@lang('messages.Ejemplo') :</b> @lang('messages.TrabajadorInfoEjemplo') <!-- <b>Ejemplo:</b> Como informatico te contratan y tardas 1h para arreglar un ordenador, al finalizar
                            el trabajo te daran 1h para que puedas gastar tu contratando un servicio a otro usuario.-->
                        </a><br><br>
                        <li><b>@lang('messages.Cliente') :<!--Cliente :--></b></li><br>
                        <p>
                        ...
                        <a class="ejemplo"><b>@lang('messages.Ejemplo') :</b> @lang('messages.ClienteInfoEjemplo') <!--<b>Ejemplo:</b> Necesitas que te cuiden el jardin y como ya has trabajado de informatico tienes 1h para gastar
